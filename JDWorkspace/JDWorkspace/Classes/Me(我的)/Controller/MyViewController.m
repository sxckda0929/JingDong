...
- (void)more{
    ...
    [settingTVC setHidesBottomBarWhenPushed:YES];
...
-(UIImageView*)addHeaderBar{
    ...
    BTRippleButtton *unLoginBtnBg          = [[BTRippleButtton alloc]
                                              ...
                                              onCompletion:^(BOOL success) {
                                                  MyAccountTableViewController *  MyAccount=[[MyAccountTableViewController alloc]init];

                                                  [ MyAccount setHidesBottomBarWhenPushed:YES];
    ...
    UILabel * address=[[UILabel alloc]initWithFrame:CGRectMake(self.view.frame.size.width-120, header.size.height-80, 120, 20)];
...
- (void)OnClick:(UIButton*)sender{
    ...
    switch (sender.tag) {
        case 1:{
            ...
            [myOrderTVC setHidesBottomBarWhenPushed:YES];
